...
import com.highpoint.gson.JsonDeserializationContext;
import com.highpoint.gson.JsonDeserializer;
import com.highpoint.gson.JsonElement;
import com.highpoint.gson.JsonNull;
...
public class DefaultTypeAdaptersTest extends TestCase {
  ...
  public void testJsonElementTypeMismatch() {
    try {
      ...
      assertEquals("Expected a com.highpoint.gson.JsonObject but was com.highpoint.gson.JsonPrimitive",
          expected.getMessage());
    }
  }
