...
import com.highpoint.gson.ParameterizedTypeFixtures;
...
public class ParameterizedTypesTest extends TestCase {
  ...
  public void testParameterizedTypeDeserialization() throws Exception {
    ...
    ParameterizedTypeFixtures.MyParameterizedType<BagOfPrimitives> expected = new ParameterizedTypeFixtures.MyParameterizedType<BagOfPrimitives>(bag);
    Type expectedType = new TypeToken<ParameterizedTypeFixtures.MyParameterizedType<BagOfPrimitives>>() {}.getType();
    TestTypes.BagOfPrimitives bagDefaultInstance = new TestTypes.BagOfPrimitives();
    Gson gson = new GsonBuilder().registerTypeAdapter(
        expectedType, new ParameterizedTypeFixtures.MyParameterizedTypeInstanceCreator<BagOfPrimitives>(bagDefaultInstance))
        .create();

    String json = expected.getExpectedJson();
    ParameterizedTypeFixtures.MyParameterizedType<BagOfPrimitives> actual = gson.fromJson(json, expectedType);
